...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sqll ="select * from subcategory";
...
<% 
	while(resultSet.next()){
       ...
       <td class="edit_button"><a href="edit_subcat.jsp?subcat_name=<%=resultSet.getString("subcat_name") %>"><input type="button"   name="submit1" value="Edit"></a></td>
       <td class="delete_button"><a href="delete_subcat.jsp?subcat_name=<%=resultSet.getString("subcat_name") %>"><input type="button"   name="submit1" value="Delete"></a></td>
